...
class NanoCLexer(Lexer):
    ...
    tokens = { OPBIN, ID, WHILE, MAIN, IF, NUMBER, LBRACE, RBRACE, LPAREN, RPAREN,
               SEMICOLON, COMMA, EQUAL, LTE, LT, GTE, GT, RETURN,GUILL,CHAR }
    ...
    @_(r'[a-z]+')
    def ID(self, t):
        if(re.start(r'[a-zA-Z0-9]',t.value)!=None):
            t.type = 'CHAR'
            print('ok',t)
        return t
...
programme = '''main(a,b,c){a = c; while(a >= 1){a = a + 1;b = b - 1;} return "dazhdzgdFFDy";}'''
...
## Code de chaîne de caractères 
    
    @_('GUILL charlist GUILL')
    def expr(self,p):
        return ('str',p[1])
